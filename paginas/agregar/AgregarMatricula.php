...
if (isset($_POST['enviar'])) {
    ...
    $id_pensum = idPensum($programa, $semestre);
    $can_clases=  cantidadClasesProgramaPensum($id_pensum);
    $valor = valorProgramaPensum($id_pensum);

    $valorporcuotas = $valor / $can_clases;
    ...
    $id_estudiante = idEstudiante($cedula_estudiante);
    

    
        if (estudianteExiste($cedula_estudiante)) {
            
            
            if (!matriculaExiste($id_estudiante, $programa, $semestre)) {

                if (guardarMatricula($id_estudiante, $programa, $semestre, $valor, $can_clases, $valorporcuotas)) {
                                $resultado = "La MATRICULA fué registradoa correctamente";
                                sleep(1);
                                header('Location:../vistas/VerMatriculas.php');
                            }else{
                                $errors[] ="Hubo un error al registrar la MATRICULA.";
                            }
            }else{
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4">
                       <!-- <a href="#!"><img class="card-img-top" src="" alt="..." /></a>-->
                        ...
                        <h2 align="center" class="text-danger"> <strong>  MATRICULAS </strong></h2>
