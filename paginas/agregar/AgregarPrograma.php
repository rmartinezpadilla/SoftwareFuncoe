            ...
            //echo "Muy bien, todo bien.";
                    ...
                    if (!programaExiste($nombre)) {
                        ...
                        //echo "usuario no existe.";
                                ...
                                if (guardarPrograma($nombre)) {
                                    $resultado = "El PROGRAMA fué registrado correctamente";
                                    sleep(1);
...
<html lang="es">
    <head>
        ...
        <title>Registrar Programa : FUNCOE</title>
        <!-- Favicon-->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4">
                       <!-- <a href="#!"><img class="card-img-top" src="" alt="..." /></a>-->
                        ...
                        <h2 align="center" class="text-danger"> <strong>  FORMULARIO REGISTRO PROGRAMA</strong></h2>
                                               
                        <label for="" class="text-danger">Nombre  del progama:</label>
                                    <div class="input-group mb-1">                                    
                                        <!-- Input para el usuario -->
                                        <input type="text" placeholder="Programa" autocomplete="off" name="nombre" class="form-control" required>
                                    </div>
