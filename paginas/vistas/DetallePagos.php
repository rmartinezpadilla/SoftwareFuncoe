...
<html lang="es">
    ...
    <body>
        ...
        <div class="row justify-content-md-center text-center">
                                ...
                                <div class="col">
                                <a  href="./DetalleMatricula.php?id=<?php echo $ced_estudiante; ?>" style="color:#FF0000;">Volver</a>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    if (estudianteExiste($ced_estudiante)) {
                        ...
                        $sql = "SELECT * FROM pagos WHERE matricula_id = $id_matricula";
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            ?>     
                             <tr>      
                                ...
                                <?php if ($pago['concepto_id'] == 18) {?>
                                <td> <?php echo htmlspecialchars(nombreConcepto( $pago['concepto_id']) . ' ' . $nro_cuota);?> </td>
                                <?php $nro_cuota++;
                                }else{?>
                                ...
                                <td> <?php echo htmlspecialchars(number_format($pago['valor'], 0, '.', ','));?> </td>                            
                                <td> <?php echo htmlspecialchars( $pago['fecha_pago']);?> </td>  
                                                              
                                <td><a href="../edits/EditarPago.php?id=<?php echo htmlspecialchars($pago['id_pago']); ?>"><button class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Editar</button></a></td>    
                                <td><a href="../eliminar/BorrarPago.php?id=<?php echo htmlspecialchars($pago['id_pago']); ?> " onclick="return ConfirmDelete()"><button class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i> Eliminar</button></a></td>    
                                
                                    
                                </tr>
                                    <?php 
                                    $total_abonado = $total_abonado + $pago['valor'];
                                    $contador++;
                    ...
                    <?php if(isset($total_abonado)){ ?>

                        <div class="alert alert-success text-center">           
            <a>Total recibido: <?php echo  number_format($total_abonado, 0, '.', ',') ; ?></a>                  
            <?php 
            }else{
                ?>
