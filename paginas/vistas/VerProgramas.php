...
<html lang="es">
    <head>
        ...
        <title>Programas - <?php echo $_SESSION['user'];?></title>
        <!-- Favicon-->
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            ?>     
                             <tr>                                                   
                                ...
                                <td><a href="../edits/EditarPrograma.php?id=<?php echo htmlspecialchars($programa['id_programa']); ?>" ><button class="btn btn-primary btn-sm"><i class="far fa-edit"></i> Editar</button></a></td>
                                <td><a href="DetallePrograma.php?id=<?php echo htmlspecialchars($programa['id_programa']); ?>"><button class="btn btn-success btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Módulos</button></a></td> 
                                <td><a href="InfoPrograma.php?id=<?php echo htmlspecialchars($programa['id_programa']); ?>" ><button class="btn btn-warning btn-sm"><i class="far fa-eye"></i> Detalle</button></a></td>
                            ...
                            <?php 							
                                        ...
                                        $errors[] = "No hay ningún PROGRAMA registrado.";
                                    }
                                    }else{
