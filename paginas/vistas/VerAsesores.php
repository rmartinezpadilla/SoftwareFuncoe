...
<html lang="es">
    <head>
        ...
        <title>Asesores Registrados - <?php echo $_SESSION['user'];?></title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <div class="row justify-content-md-center  text-center">
                                ...
                                <div class="col">
                                <p class="card-text"> <a href="../agregar/AgregarAsesor.php"style="color:#FF0000;">Agregar Asesor</a></strong></p>
                                </div>
                                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-2">
                      ...
                      <a href="../../reportes/imprimirAsesores.php"><button class="btn btn-danger" name="enviar">Generar PDF</button></a>
                       <p></p>                               
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            ?>     
                             <tr>                           
                                ...
                                <td> <?php echo htmlspecialchars($turno['nombre_asesor']);?> </td>
                                <td> <?php echo htmlspecialchars($turno['telefono']);?> </td>                                
                                <td> <?php echo htmlspecialchars($turno['fecha_registro']);?> </td>                                                                    
                                
                                <td><a href="../edits/EditarAsesor.php?id=<?php echo htmlspecialchars($turno['id_asesor']); ?>"><button class="btn btn-primary btn-sm"><i class="far fa-edit"></i> Editar</button></a></td>
                                <!-- <td><a href="AddTurno.php?id=<?php echo htmlspecialchars($turno['id_asesor']); ?>"><button class="btn btn-danger btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Turno</button></a></td>  -->
                            ...
                            <?php 
                                        ...
                                        $errors[] = "No hay ningún ASESOR registrado.";
                                    }
                                    }else{
