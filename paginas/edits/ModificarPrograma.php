...
if (isset($_POST['enviar'])) {
    ...
    $minombre =strtoupper( $mysqli->real_escape_string($_POST['nombreprograma']));   
    $mi_id =  $mysqli->real_escape_string($_POST['mi_id']);



        $sql = "UPDATE programa SET nombre_programa='$minombre' WHERE id_programa='$mi_id'";
						...
						//veificamos que haya sido definida
							if (isset($resultado)) {
								...
								if ($resultado) {
                                    ...
                                    <strong>¡Programa!</strong>  Actualizado Correctamente.
