...
if (isset($_POST['enviar'])) {
    ...
    $area =strtoupper( $mysqli->real_escape_string($_POST['area']));  
    $mi_id =  $mysqli->real_escape_string($_POST['mi_id']);

        $sql = "UPDATE docente SET cedula='$cedula', nombre_comp_docente='$minombre', programa_id='$area' WHERE id_docente='$mi_id'";
...
<html lang="es">
    <head>
        ...
        <title>Modificar Docentes - <?php echo $_SESSION['user'];?></title>
        <!-- Favicon-->
						...
						//veificamos que haya sido definida
							if (isset($resultado)) {
								...
								if ($resultado) {
                                    ...
                                    <strong>Docente!</strong>  Actualizado Correctamente.
                                    <a href="../vistas/VerDocentes.php">Volver</a>
                                    </div>
                                    <?php
